...
import { staggerContainer, fadeIn } from "../effects/variants";
      ...
      >
        <div className="flex justify-between items-center px-4 lg:px-0 relative text-white">
          <motion.div
            ...
            className={`${
              nav ? "gap-y-0" : "gap-y-2"
            } flex flex-col items-center justify-center w-12 h-12 p-2 order-2 lg:order-none cursor-pointer border-2 rounded-full`}
            onClick={() => setNav(!nav)}
          >
            <motion.div
              initial={{
