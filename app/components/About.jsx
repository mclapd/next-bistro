...
import { plateVariants, staggerContainer, fadeIn } from "../effects/variants";
  ...
  return (
    <section className="min-h-[620px]">
      <div className="container mx-auto min-h-[620px]">
        ...
        >
          <motion.div
            variants={fadeIn("rihgt", "tween", 0.2, 1.8)}
            className="flex-1 text-center lg:text-left"
          >
            <div className="pretitile">{pretitle}</div>
          ...
          >
            <Image src={image} width={778} height={682} alt="image" />
          </motion.div>
        </motion.div>
      </div>
    </section>
